...
public class Alerta extends javax.swing.JFrame {
    ...
    private void btnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultaActionPerformed
        ...
        boolean res = med.stockMedicamento(codigo,nombre,marca);        
        if(res == true){
            JOptionPane.showMessageDialog(null,"Stck Suficiente","",JOptionPane.INFORMATION_MESSAGE);
        }else{
            JOptionPane.showMessageDialog(null,"Reponer medicamento,stock insuficiente","",JOptionPane.INFORMATION_MESSAGE);            
         }
